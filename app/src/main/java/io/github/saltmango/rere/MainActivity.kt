package io.github.saltmango.rere
...
import io.github.saltmango.rere.ui.navigation.AppNavigation
import io.github.saltmango.rere.ui.theme.Bg1
import io.github.saltmango.rere.ui.theme.ReReTheme
...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (io.github.saltmango.rere.data.FirebaseGate.isConfigured(applicationContext)) {
        ...
        if (savedInstanceState == null) {
            Thread {
                io.github.saltmango.rere.data.MaintenanceNotifier.check(
                    applicationContext, sync.maintenanceItems(), sync.odometer().toInt()
                )
                io.github.saltmango.rere.data.MaintenanceNotifier.checkDocuments(applicationContext, sync.documents())
            }.start()
        }
