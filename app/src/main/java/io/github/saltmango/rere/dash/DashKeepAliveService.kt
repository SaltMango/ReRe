...
import io.github.saltmango.rere.MainActivity
import io.github.saltmango.rere.R

/**
 * Foreground service that keeps reRe streaming to the dash while the
...
class DashKeepAliveService : Service() {
    companion object {
        ...
        private const val CHANNEL_ID   = "rere_dash"
        private const val NOTIF_ID     = 4701
        const val ACTION_START = "io.github.saltmango.rere.DASH_START"
        const val ACTION_STOP  = "io.github.saltmango.rere.DASH_STOP"
    ...
    private fun startForegroundLocks() {
        ...
        try {
            ...
            io.github.saltmango.rere.util.Telemetry.recordNonFatal(e, "DashKeepAliveService.startForegroundLocks")
            stopSelf()
        }
    }
    ...
    private fun acquireLocks() {
        ...
        wakeLock = pm.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "rere:dash").apply {
        ...
        @Suppress("DEPRECATION")
        wifiLock = wm.createWifiLock(WifiManager.WIFI_MODE_FULL_HIGH_PERF, "rere:dash").apply {
            setReferenceCounted(false)
            acquire()
        }
    }
    ...
    private fun buildNotification(): Notification {
        ...
        return builder
            .setContentTitle("reRe — streaming to dash")
