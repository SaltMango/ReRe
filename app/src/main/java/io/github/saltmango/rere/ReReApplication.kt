...
import io.github.saltmango.rere.data.DiagnosticsUploader
import io.github.saltmango.rere.data.FirebaseFeatures
import io.github.saltmango.rere.util.BuildId
import io.github.saltmango.rere.util.CrashGuard
import io.github.saltmango.rere.util.ExitInfoCollector

class ReReApplication : Application() {
    ...
    private fun rebindNotificationListener() {
        ...
        runCatching {
            if (io.github.saltmango.rere.media.MediaInfoProvider.isAccessGranted(this)) {
                android.service.notification.NotificationListenerService.requestRebind(
                    android.content.ComponentName(this, io.github.saltmango.rere.media.ReReNotificationListener::class.java)
                )
            }
        }
    }
