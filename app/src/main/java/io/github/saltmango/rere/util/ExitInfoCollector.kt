package io.github.saltmango.rere.util
 ...
 * any NEW abnormal exits and write them to a diag/crash-*.log, which [io.github.saltmango.rere.data.
...
object ExitInfoCollector {
    ...
    private const val PREFS = "rere_exitinfo"
    ...
    private fun writeExit(context: Context, dir: File, info: ApplicationExitInfo) {
        ...
        val text = buildString {
            appendLine("=== reRe process exit (ApplicationExitInfo) ===")
