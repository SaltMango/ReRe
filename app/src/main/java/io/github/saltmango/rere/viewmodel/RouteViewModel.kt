...
import io.github.saltmango.rere.data.SharedLocation
...
import io.github.saltmango.rere.util.LocationParser
...
class RouteViewModel(app: Application) : AndroidViewModel(app) {
    ...
    private val _saved = MutableStateFlow<List<io.github.saltmango.rere.data.SavedLocation>>(emptyList())
    ...
    fun renameSaved(loc: io.github.saltmango.rere.data.SavedLocation, name: String, note: String) =
        viewModelScope.launch { withContext(Dispatchers.IO) { repo.renameSaved(loc, name, note) } }

    fun deleteSaved(loc: io.github.saltmango.rere.data.SavedLocation) =
    ...
    fun selectSaved(loc: io.github.saltmango.rere.data.SavedLocation) {
