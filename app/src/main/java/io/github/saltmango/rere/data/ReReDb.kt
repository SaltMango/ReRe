 ...
 */
class ReReDb private constructor(context: Context) :
    SQLiteOpenHelper(context.applicationContext, "rere.db", null, 7) {

    companion object {
        @Volatile private var instance: ReReDb? = null
        fun get(context: Context): ReReDb =
            instance ?: synchronized(this) {
                instance ?: ReReDb(context).also { instance = it }
            }
