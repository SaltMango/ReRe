 ...
 */
class ReReNotificationListener : NotificationListenerService() {
    ...
    // ReReApplication should have re-bound it).
    override fun onListenerConnected() {
        io.github.saltmango.rere.data.RideDiagnostics.log("media", "notification listener CONNECTED")
    }

    override fun onListenerDisconnected() {
        io.github.saltmango.rere.data.RideDiagnostics.log("media", "notification listener DISCONNECTED")
    }
    ...
    override fun onNotificationPosted(sbn: StatusBarNotification?) {
        ...
        io.github.saltmango.rere.data.RideDiagnostics.log("media",
