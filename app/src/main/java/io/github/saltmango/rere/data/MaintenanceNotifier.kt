...
object MaintenanceNotifier {
    ...
    fun checkDocuments(context: Context, docs: List<io.github.saltmango.rere.data.VehicleDocument>) {
        val ctx = context.applicationContext
        ...
        fun line(d: io.github.saltmango.rere.data.VehicleDocument): String {
